...
Treina o(s) modelo(s) declarado(s), avalia mÚtricas e salva o artefato.
"""
...
# --- PrÚ-processamento ---
# Separa features e alvo; codifica colunas categ¾ricas com one-hot encoding
X = df[FEATURES].copy()
...
# Codifica o alvo categ¾rico para modelos de classificaþÒo
label_encoder = None
if y.dtype == 'object' or str(y.dtype) == 'string':
    label_encoder = LabelEncoder()
    y = label_encoder.fit_transform(y)

# --- DivisÒo treino/teste (80/20) ---
